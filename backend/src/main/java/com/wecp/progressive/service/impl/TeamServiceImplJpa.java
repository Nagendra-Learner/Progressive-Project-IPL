...
public class TeamServiceImplJpa implements TeamService
{
    ...
    { 
        ...
        {
            throw new TeamDoesNotExistException("Team with given " + teamId + " doesnot exists.");
        }
    ...
    public void updateTeam(Team team)
    {
        if(!teamRepository.existsById(team.getTeamId()))
        {
            throw new TeamDoesNotExistException("Team with given " + team.getTeamId() + " doesnot exists.");
        }
